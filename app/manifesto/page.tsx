      ...
      <article className="mx-auto max-w-3xl rounded-3xl border border-border bg-card/80 p-8 sm:p-12">
        ...
        <div className="space-y-9 text-lg leading-relaxed text-foreground/95">
          <section>
            ...
            <p>Church is alive every second of every day.</p>
          </section>

          <section>
            <h2 className="mb-3 text-3xl">Why Church Exists</h2>
          ...
          <section>
            <h2 className="mb-3 text-3xl">We Are the Church</h2>
            <p>The Church is not owned.</p>
          ...
          <section>
            <h2 className="mb-3 text-3xl">The Revival and Church</h2>
            <p>The Revival is God’s movement.</p>
            <p>Church is where the Body gathers.</p>
            <p>Together, they point the world back to Christ.</p>
          </section>

          <section>
            <h2 className="mb-3 text-3xl">This Is Church</h2>
            <p>Alive. Gathered. Faithful.</p>
            <p>Every second. Every place. Every believer.</p>
          </section>
        </div>
      </article>
    </section>
