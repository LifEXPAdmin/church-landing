...
| AC-18 | Passed, published with real intake off | Receipt, replies, state, reasoned resolution/reopen, feature decision separation and unassigned state. |
