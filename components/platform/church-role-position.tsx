  ...
  return (
    <div ref={formRef} className="space-y-4">
      ...
      {choice !== selected && (
        <div className="space-y-2 rounded-xl border border-gc-divider p-3">
          <p>
            ...
            responsibilities when you apply it. The new position starts in Not
            connected yet; choose its placement after creating it.
          </p>
      ...
      <PortalActionForm
        ...
        description="The title and responsibilities are copied into this position. It starts in Not connected yet. No assignment or software permission is granted."
      />
    </div>
  );
}
