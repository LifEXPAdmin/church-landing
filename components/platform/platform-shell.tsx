  ...
  return (
    <div className="min-h-screen bg-[#100b07] text-[#f8ead6]">
      ...
      <div className="fixed inset-x-0 bottom-0 z-40 border-t border-[#f2d8af]/20 bg-[#17100b]/95 backdrop-blur md:hidden">
        <div className="container-shell grid grid-cols-4 gap-2 py-2 text-xs">
          ...
          {user ? (
            <form action={logoutPlatformAccount}>
              <button type="submit" className="flex w-full flex-col items-center rounded-xl py-2 text-[#f8ead6] hover:bg-white/10">
                <LogOut className="mb-1 h-4 w-4 text-[#f4c98c]" />
                Logout
              </button>
            </form>
          ) : (
