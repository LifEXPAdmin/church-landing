...
export const settingsHelpTopics = [
  { id: "calendar-reminders", title: "How do event reminders work?", keywords: "calendar reminder Going Maybe timed event minutes phone quiet hours subscriptions", body: "Open Settings, Calendar, Event notification preferences. Reminders start Off. Choose 15 or 60 minutes before timed events marked Going or Maybe. Only future reminder times count. All-day events and following a calendar do not create calendar reminders. Volunteer shift reminders have a separate choice that starts Off; they use your confirmed shift start, stop after cancellation or loss of access and do not apply to untimed roles. Applying or signing up never turns either reminder choice on. Activity and phone choices stay separate. Phone reminders need event notifications and a current device; quiet hours apply and delivery stops when the event starts. Hiding or unfollowing a calendar does not cancel an RSVP, reminder or church membership.", href: "/platform/settings/notifications/availability", action: "Open event notification preferences" },
  { id: "calendar-display", title: "How do I save my calendar display?", keywords: "calendar week start Sunday Monday default view agenda month fixed device time zone formats", body: "Open Settings, Calendar, Saved calendar display. Choose your week start, Agenda or Month view, and a fixed time zone or Follow this device’s time zone. Device following checks the browser zone when a calendar view opens. Temporary view controls do not replace saved defaults. Date and time formats share the same account preferences as Language and location. Event source times, all-day dates, hidden calendars, notification quiet hours and sharing stay separate.", href: "/platform/settings/calendar/view", action: "Open saved calendar display" },
