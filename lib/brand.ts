// Existing site identity: paper/olive/ink and the Lucide Church mark.
// Church path data: lucide-react 0.475.0, ISC; see public/brand/LICENSE.txt.
export const brandColors = {
  paper: "#f7f4ed",
  olive: "#385842",
  ink: "#202923"
};
export const churchMarkPaths = [
  "M10 9h4",
  "M12 7v5",
